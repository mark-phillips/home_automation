...
print("""Unicorn HAT HD: Attention
""")
...
effects = [blues_and_twos, gradient, tunnel, rainbow_search, checker, swirl]
effects_list = [[blues_and_twos], [gradient], [tunnel], [rainbow_search], [checker], [swirl]]
#effects = [gradient]
#effects = [swirl]
#effects = [checker]
#effects = [tunnel]
#effects = [rainbow_search]


step = 0

try:
    effects = effects_list[ int(sys.argv[1]) ]
